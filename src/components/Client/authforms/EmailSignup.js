...
import { useAuthContext } from "../../../contexts/Client/AuthContexts";
    ...
    <>
      ...
      >
        <InputYup
          ...
          className="form-control block w-full px-3 py-1.5 -mb-1 text-base font-normal
        ...
        <InputYup
          ...
          type="phone"
          className="form-control block w-full px-3 py-1.5 -mb-1 text-base font-normal text-gray-700
        ...
        <InputYup
          ...
          className="form-control block w-full px-3 -mb-1 py-1.5 text-base font-normal text-gray-700
        bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out 
        focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
          type="password"
        />
